<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(!empty($trackingNum)){
            $sql_update = "UPDATE cart SET tracking_number = '$trackingNum', shipping_status = 'Ongoing Shipment' WHERE cart_id='$cartID'";
                    ...
                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <table id="styling-table1">
                            <tr>
                                ...
                                <?php
                                    $sqll = "Select count(*) from cart WHERE shipping_status='paid' AND cart_id='$cartID'";
                                    ...
                                    $sql2 = "Select * from cart WHERE shipping_status='paid' AND cart_id='$cartID' limit $offset, $rec_limit";
