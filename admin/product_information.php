                            ...
                            <?php
                                ...
                                if(mysqli_num_rows($result) > 0){
                                    while($row = mysqli_fetch_assoc($result)){
                                        ...
                                        $sql_categoryName = "SELECT * FROM category WHERE category_id='$categoryID'";
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<td><a style='text-decoration: none;' href='edit_product.php?productID=".$row['product_id']."'><div class='action-btn'><span>Edit</span></div></a>
                                            <a style='text-decoration: none;' href='delete_product.php?productID=".$row['product_id']."'><div style='background-color: red; margin-top: 5px;' class='action-btn'><span>Delete</span></div></a></td>";
                                        echo "</tr>";
                                    }
                                }else{
                                    echo "<tr>";
