                ...
                <div style="width: 95%; margin: auto;">
                    ...
                    <table id="styling-table1">
                        <tr>
                            ...
                            <?php
                                $sqll = "Select count(*) from cart WHERE shipping_status='Order Received'";
                                ...
                                $sql2 = "Select * from cart WHERE shipping_status='Order Received' limit $offset, $rec_limit";
                                ...
                                if(mysqli_num_rows($result) > 0){
                                    while($row = mysqli_fetch_assoc($result)){
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<td><button class='action-btn' onclick=\"linkTrack('".$row['tracking_number']."')\">TRACK</button></td>";
                                        echo "</tr>";
                                    }
                                }else{
                                    echo "<tr>";
