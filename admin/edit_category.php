<?php
    ...
    $sql_categoryInformation = "SELECT * FROM category WHERE category_id='$categoryID'";
    ...
    if(isset($_POST["submit"])){
        ...
        if(!empty($categoryName)){
            //CHECK FOR NAME DUP
            $sql_checkDup = "SELECT * FROM category WHERE name='$categoryName'";
            ...
            if(empty($submitErr)){
                //UPLOAD to DMBS
                $sql_insert = "UPDATE category SET name='$categoryName' WHERE category_id='$categoryID'";

                if(mysqli_query($conn, $sql_insert)){
                    header("location: category_information.php?status=Category Successfully Edited!");
                }else{
