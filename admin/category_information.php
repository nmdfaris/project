    ...
    <header>
        <div class="container-wrapper">
            ...
            <div id="container-wrapper-item2">
                ...
                <img id="wrapper-staff-pic" src="../resource/profile_pic/user.jpg"></img>
            </div>
        </div>
    </header>
                ...
                <div style="width: 80%; margin: auto;">
                    ...
                    <table id="styling-table1">
                        <tr>
                            ...
                            <?php
                                $sqll = "Select count(*) from category";
                                ...
                                $sql2 = "Select * from category limit $offset, $rec_limit";
                                ...
                                if(mysqli_num_rows($result) > 0){
                                    while($row = mysqli_fetch_assoc($result)){
                                        ...
                                        $sql_countItems = "SELECT * FROM product WHERE category='$categoryID'";
                                        $res_countItems = mysqli_query($conn, $sql_countItems);
                                        
                                        if(mysqli_num_rows($res_countItems) > 0){
                                            while($totalNumOfItem = mysqli_fetch_array($res_countItems)){
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<td>".$num_of_items."</td>";
                                            echo "<td><a style='text-decoration: none;' href='edit_category.php?categoryID=".$row['category_id']."'><div class='action-btn'><span>Edit</span></div></a>
                                            <a style='text-decoration: none;' href='delete_category.php?categoryID=".$row['category_id']."'><div style='background-color: red; margin-top: 5px;' class='action-btn'><span>Delete</span></div></a></td>";
                                        echo "</tr>";
                                    }
                                }else{
                                    echo "<tr>";
