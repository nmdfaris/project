                ...
                <div style="width: 95%; margin: auto;">
                    ...
                    <table id="styling-table1">
                        <tr>
                            ...
                            <?php
                                $sqll = "Select count(*) from cart WHERE shipping_status='paid'";
                                ...
                                $sql2 = "Select * from cart WHERE shipping_status='paid' limit $offset, $rec_limit";
                                ...
                                if(mysqli_num_rows($result) > 0){
                                    while($row = mysqli_fetch_assoc($result)){
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<td>".$row['date']."</td>";
                                            echo "<td><a style='text-decoration: none;' href='ship_product.php?cartID=".$row['cart_id']."'><div class='action-btn'><span>Ship</span></div></a></td>";
                                        echo "</tr>";
                                    }
                                }else{
                                    echo "<tr>";
