<?php
    ...
    if(isset($_POST['login'])){
        ...
        $sql_validate = "SELECT * FROM user WHERE email='$staffID' AND password='$password' AND permission='admin'";
...
<body id="register_background">
    <div class="register_logo">
        <img id="register_logo" src="../resource/images/flavour_of_the_month.jpg"></img>
    </div>
    ...
    <p style="color: white; text-align: center;">Forget Password? Password is "admin".</p>
    <a href="login.php"><p style="color: white; text-align: center; font-size: 1.2rem;">Back</p></a>
</body>
