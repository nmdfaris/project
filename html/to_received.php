  ...
  <body style="background-color:rgb(233, 233, 233);" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-image u-sticky u-header" id="sec-2fcf" data-image-width="1200" data-image-height="675"><div class="u-clearfix u-sheet u-sheet-1">
      ...
      <section>
        ...
        <div class="mycart-nav-bar">
            ...
            <div onclick="window.location='to_received.php'" style="border-bottom: 4px solid rgb(57, 128, 235);" class="mycart-nav-bar-item">
        ...
        <div class="mycart-container">
            ...
            <br>
                <?php
                    $sqll = "Select count(*) from cart WHERE customer_id='$uid' AND shipping_status='Ongoing Shipment'";
                    ...
                    $sql2 = "Select * from cart WHERE customer_id='$uid' AND shipping_status='Ongoing Shipment' limit $offset, $rec_limit";
                            ...
                            echo "<div style='margin: auto; width: 80%; border: solid black 2px;'>";
                                ...
                                echo "<div class='mycart-item-lower'>";
                                    ...
                                    echo "<div class='mycart-item-lower-2'>";
                                        ...
                                        echo "<div id='paynow-btn' onclick=\"window.location='order_received.php?cartID=".$row['cart_id']."'\">Order Received</div>";
                                    echo "</div>";
                                echo "</div>";
