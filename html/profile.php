  ...
  <body style="background-color:rgb(233, 233, 233);" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-image u-sticky u-header" id="sec-2fcf" data-image-width="1200" data-image-height="675"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <nav class="u-menu u-menu-one-level u-offcanvas u-menu-2">
          ...
          <?php
              if(empty($uid)){
                ...
                echo '<ul class="u-nav u-unstyled u-nav-5"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-grey-5 u-text-grey-5 u-text-hover-palette-2-base" href="logout.php" style="padding: 10px 20px;">Logout</a>';
              }
            ?>
          </div>
          <div class="u-custom-menu u-nav-container-collapse">
      ...
      <section>
        ...
        <div class="mycart-nav-bar">
            <div onclick="window.location='profile.php'" style="border-bottom: 4px solid rgb(57, 128, 235);" class="mycart-nav-bar-item">
                <span>To Ship</span>
            </div>
        ...
        <div class="mycart-container">
            ...
            <br>
                <?php
                    $sqll = "Select count(*) from cart WHERE customer_id='$uid' AND shipping_status='paid'";
                    ...
                    $sql2 = "Select * from cart WHERE customer_id='$uid' AND shipping_status='paid' limit $offset, $rec_limit";
